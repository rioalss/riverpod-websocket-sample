...
mixin _$MessageModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, timestamp, input);

  @override
  String toString() {
    return 'MessageModel(timestamp: $timestamp, input: $input)';
  }
}
...
abstract mixin class $MessageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? timestamp, String? input});
}
...
extension MessageModelPatterns on MessageModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int? timestamp, String? input)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _MessageModel() when $default != null:
        return $default(_that.timestamp, _that.input);
      case _:
        return orElse();
    }
  }
...
class _MessageModel implements MessageModel {
  const _MessageModel({this.timestamp, this.input});
